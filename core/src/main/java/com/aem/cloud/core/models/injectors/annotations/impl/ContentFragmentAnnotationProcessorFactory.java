...
public class ContentFragmentAnnotationProcessorFactory implements StaticInjectAnnotationProcessorFactory {
    @Override
    public InjectAnnotationProcessor2 createAnnotationProcessor(AnnotatedElement element) {
        return Optional.ofNullable(
            element.getAnnotation(ContentFragment.class)
        ).map(ContentFragmentAnnotationProcessorFactory.PagePropertyAnnotationProcessor::new)
        .orElse(null);
    }

    private static class PagePropertyAnnotationProcessor extends AbstractInjectAnnotationProcessor2 {
        private final ContentFragment annotation;

        public PagePropertyAnnotationProcessor(ContentFragment annotation) {
